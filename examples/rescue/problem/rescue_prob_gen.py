...
class StateSampler:
    ...
    def sample(self, state_name="init_state"):
        ...
        state.loc = {
            "r1": rigid_relations["base_loc"],
            "w1": rigid_relations["base_loc"],
            "a1": rigid_relations["base_loc"],
            "p1": rigid_relations["other_loc"][0],
            "p2": rigid_relations["other_loc"][1],
            "p3": rigid_relations["other_loc"][2],
        }
        ...
        state.status = {
            ...
            "p3": "unk",
            state.loc["p3"]: "unk",
            rigid_relations["other_loc"][3]: "unk",
            rigid_relations["other_loc"][4]: "unk",
        }
        ...
        state.real_status = {
            ...
            "p3": "injured",
            state.loc["p3"]: "clear",
            rigid_relations["other_loc"][3]: "debri",
            rigid_relations["other_loc"][4]: "debri",
        }

        state.real_person = {
            rigid_relations["other_loc"][0]: "p2",
            rigid_relations["other_loc"][1]: "p2",
            rigid_relations["other_loc"][2]: "p3",
            rigid_relations["other_loc"][3]: None,
            rigid_relations["other_loc"][4]: None,
        }

        state.new_robot = {1: None}
        state.weather = {
            rigid_relations["other_loc"][0]: "clear",
            rigid_relations["other_loc"][1]: "clear",
            rigid_relations["other_loc"][2]: "clear",
            rigid_relations["other_loc"][3]: "clear",
