...
init_state.job_tasks = {"job1": ["taskA", "taskB"], "job2": ["taskC", "taskD"]}
...
init_state.machine_available = {"machine1": True, "machine2": True}

# Task lists
task_list_1 = [("schedule_job", "job1")]
task_list_2 = [("schedule_job", "job1"), ("schedule_job", "job2")]
