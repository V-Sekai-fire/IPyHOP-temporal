...
def main():
    ...
    ), f"Result plan {actual_actions} and expected plan {expected_actions} are not same"
    ...
    assert (
        actual_actions_2 == expected_actions_2
    ), f"Result plan {actual_actions_2} and expected plan {expected_actions_2} are not same"
