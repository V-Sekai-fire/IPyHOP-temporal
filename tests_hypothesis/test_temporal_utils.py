...
def valid_iso8601_durations(draw):
    ...
    seconds = draw(st.floats(0.0, 59.9, width=53))
...
def test_parse_none_duration_returns_none(None):
...
@settings(max_examples=10)
def test_add_duration_none_datetime_returns_none(None, duration_str):
...
@given(st.none())
@settings(max_examples=10)
def test_duration_to_seconds_none_returns_none(None):
